...
plt.ylim([5, n])
plt.subplot(1, 3, 2)
ax1 = plot_histogram(counts, n, h_slice, pdf1, c=_ref)
plt.subplot(1, 3, 3)
ax2 = plot_histogram(counts, n, h_slice, pdf1, c=_alt, s=1)
ax1.yaxis.set_major_formatter(FormatStrFormatter('%.3f'))
...
plt.ylim([5, n])
plt.subplot(1, 3, 2)
ax1 = plot_histogram(counts, n, n_slice, pdf2, c='k', slc_sum=True,)
plt.subplot(1, 3, 3)
ax2 = plot_histogram(counts, n, n_slice, pdf2, c='k', s=1, slc_sum=True,)
ax1.yaxis.set_major_formatter(FormatStrFormatter('%.3f'))
ax2.yaxis.set_major_formatter(FormatStrFormatter('%.3f'))
plt.tight_layout()
plt.savefig('sum_slice.pdf')
